...
/* 
   ...
   ID: 0x0001  Byte:  11   比赛机器人状态       发送频率 1Hz 
   ID: 0X0002  Byte:  1    比赛胜负数据         比赛结束时发送一次   
   ID: 0x0202  Byte: 14    实时功率和热量数据   发送频率 50Hz   20MS发送一次
   ID: 0X0203  Byte: 16    机器人位置朝向信息   发送频率 10Hz 
   ID: 0X0204  Byte:  1    获取增益数据         增益数据改变后发送
   ID: 0x0206  Byte:  1    伤害数据             受到伤害时发送      
   ID: 0x0207  Byte:  6    实时射击数据         发射弹丸时发送  
   ID: 0x0209  Byte:  4    RFID状态             发送频率 1Hz        
   ID: 0x0302  Byte:  n    自定义数据           限制频率 30Hz
*/
...
/* ID: 0x0002  Byte:  1 */  //0 平局 1 红方胜利 2 蓝方胜利
typedef __packed struct
{
 uint8_t winner;
} ext_game_result_t;
...
/* ID: 0x0204  Byte:  1 *///buff  bit0:机器人血量补血状态   bit1:枪口热量冷却加速  bit2:防御加成  bit3:攻击加成
typedef __packed struct
{
...
typedef __packed struct
{
 uint8_t bullet_type;       //1:17弹丸 2:42弹丸
 uint8_t shooter_id;       //ID 1:1号17mm发射机构  2:2号17mm发射机构 3:42mm发射机构
